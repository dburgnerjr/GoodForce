    ...
    public void loginButton() {
        ...
        btnLogin.setOnClickListener(v -> {
            if (edtEmailAddress.getText().toString().equals(strUsername) && edtPassword.getText().toString().equals(strPassword)) {
                ...
                Toast.makeText(LoginActivity.this, "Username is" + strUsername, Toast.LENGTH_SHORT).show();
                Toast.makeText(LoginActivity.this, "Password is" + strPassword, Toast.LENGTH_SHORT).show();
                nAttempts--;
                if (nAttempts == 0) {
                    Toast.makeText(LoginActivity.this, "Please reset your password to continue", Toast.LENGTH_SHORT).show();
                    btnLogin.setEnabled(false);
                }
            }
        });

        btnForgotPW.setOnClickListener(view -> {
